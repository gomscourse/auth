...
// Validate checks the field values on UserCreateInfo with the rules defined in
...
// ValidateAll checks the field values on UserCreateInfo with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in UserCreateInfoMultiError,
// or nil if none found.
func (m *UserCreateInfo) ValidateAll() error {
	return m.validate(true)
}

func (m *UserCreateInfo) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return UserCreateInfoMultiError(errors)
	}

	return nil
}

func (m *UserCreateInfo) _validateHostname(host string) error {
...
func (m *UserCreateInfo) _validateEmail(addr string) error {
...
// UserCreateInfoMultiError is an error wrapping multiple validation errors
// returned by UserCreateInfo.ValidateAll() if the designated constraints
// aren't met.
...
func (m UserCreateInfoMultiError) AllErrors() []error { return m }

// UserCreateInfoValidationError is the validation error returned by
// UserCreateInfo.Validate if the designated constraints aren't met.
...
func (e UserCreateInfoValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UserCreateInfoValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UserCreateInfoValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UserCreateInfoValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UserCreateInfoValidationError) ErrorName() string { return "UserCreateInfoValidationError" }
...
var _ error = UserCreateInfoValidationError{}
